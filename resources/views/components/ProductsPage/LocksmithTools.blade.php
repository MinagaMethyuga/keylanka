<div id="locksmith-tools-set" class="hidden grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="md:col-span-2">
        <label class="flex flex-col w-full">
            <p class="text-white text-base font-medium leading-normal pb-2">Product Title (Locksmith)</p>
    ...
    <div>
        <label class="flex flex-col w-full">
            <p class="text-white text-base font-medium leading-normal pb-2">Brand Category</p>
            <select class="form-select w-full appearance-none rounded-lg text-white focus:outline-0 focus:ring-2 focus:ring-primary border border-[#324467] bg-[#101622] h-14 placeholder:text-[#92a4c9] p-[15px] text-base font-normal leading-normal transition-all" name="brand">
                <option>KeyDiy</option>
                <option>xHorse</option>
                <option>Other</option>
            </select>
        </label>
    </div>
